...
export const Descripation = () => {
  ...
  const data = [
    ...
    },
    {
        ...
        description:
            "Have you checked out the latest movie reviews of some of the best Hollywood movies? If so, we bet you would want to watch them all in the nearest movie theatre! With the anticipation of the release of ",
    },
    {
        title: "Exciting Tollywood & Kollywood Movies To Book Tickets",
        description:
            "Just like Bollywood and Hollywood movies, Tollywood seems to have a few good movie showtimes as well. You can plan for movies to watch this Friday with these Tollywood movies because the star cast is superb, and the storylines of these movies have already started making news. It will be super interesting to watch  ",
    },
    {
    ...
    {data.map((value, index, arr) => {
        return (
            <div>
                ...
                <p className="d_h12 fw-light text-muted mt-2">
                    {value.description}
                </p>
            </div>
        );
